...
(function (root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        ...
        function onMouseEnterOrLeave(e) {
            ...
            normalSelectors.forEach(function (normalSelector) {
                if (!isInsideOneNormalScroll) {
                    ...
                    var isNormalScrollChildFocused = closest(
                        target,
                        normalSelector,
                    );
        ...
        function doubleCheckHeight() {
            for (var i = 1; i < 4; i++) {
                g_doubleCheckHeightId = setTimeout(
                    adjustToNewViewport,
                    350 * i,
                );
            }
        ...
        function addVerticalNavigation() {
            ...
            css($(SECTION_NAV_SEL), {
                "margin-top":
                    "-" + $(SECTION_NAV_SEL)[0].offsetHeight / 2 + "px",
            });
            ...
            if (!options.autoScrolling || options.scrollBar) {
                ...
                if (!hasClass(currentSection, ACTIVE)) {
                    ...
                    var leavingSectionIndex =
                        index(leavingSection, SECTION_SEL) + 1;
                    ...
                    if (activeSlide) {
                        slideAnchorLink = activeSlide.getAttribute(
                            "data-anchor",
                        );
                ...
                if (options.fitToSection) {
                    ...
                    scrollId2 = setTimeout(function () {
                        ...
                        if (
                            ...
                            $(SECTION_ACTIVE_SEL)[0].offsetHeight <=
                                windowsHeight
                        ) {
                            fitToSection();
                        }
        ...
        */
        ...
        function isFocusOutside(e) {
            ...
            var currentFocusIndex = allFocusables.indexOf(
        ...
        function destroyStructure() {
            ...
            $(SECTION_SEL + ", " + SLIDE_SEL).forEach(function (item) {
                ...
                if (previousStyles) {
                    item.setAttribute(
                        "style",
                        item.getAttribute("data-fp-styles"),
                    );
                }
        ...
        function displayWarnings() {
            ...
            if (
                options.scrollOverflow &&
                options.scrollOverflowHandler == null
            ) {
            ...
            options.anchors.forEach(function (name) {
                ...
                var idAttr = [].slice.call($("[id]")).filter(function (item) {
                    return (
                        ...
                        item.getAttribute("id").toLowerCase() ==
                            name.toLowerCase()
                    );
                });
        ...
        function setScrolling(element, val) {
            if (
                ...
                if (
                    element.self != window &&
                    hasClass(element, SLIDES_WRAPPER)
                ) {
